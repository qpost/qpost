				...
				<div class="card-body">
					<div class="row">
						<div class="col-lg-3 mb-3">
							...
							<span class="text-muted" style="font-size: 16px">@<?= $user->getUsername(); ?></span> <?= Util::isLoggedIn() && Util::getCurrentUser()->isFollower($user) ? '<span class="text-uppercase small bg-light text-muted px-1 py-1">follows you</span>' : ""; ?>
