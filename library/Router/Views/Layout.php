					...
					<div class="row">
						...
						<div class="col-lg-9">
							<nav class="nav nav-pills nav-justified">
								<a class="nav-item nav-link<?php if(isset($profileTab) && $profileTab == PROFILE_TAB_FEED) echo " active"; ?>" href="<?= $app->routeUrl("/" . $user->getUsername()); ?>">Feed (<?= $user->getFeedEntries(); ?>)</a>
