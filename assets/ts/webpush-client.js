...
const WebPushUtils = {
	...
	checkPermission() {
		return {
			state: Notification.permission === "granted" ? "prompt" : Notification.permission,
			onchange: null
		};
	},
	...
	registerServiceWorker(serviceWorkerPath) {
		return navigator.serviceWorker.getRegistration(serviceWorkerPath).then(function (registration) {
			return registration;
		});
	},
...
window.WebPushClientFactory = {
	...
	create({
		...
		var PermissionStatus = WebPushUtils.checkPermission();
