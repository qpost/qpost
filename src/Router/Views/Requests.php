		...
		<div class="card userCard col-md-6 offset-md-3 mb-3" data-user-id="<?= $u->getId(); ?>">
			<div class="card-body">
				<center>
					...
					<?= (($u->getPrivacyLevel() == PrivacyLevel::PUBLIC || (Util::isLoggedIn() && $u->isFollower(Util::getCurrentUser()->getId()))) && (!is_null($u->getBio()))) ? '<p class="mb-0 mt-2">' . Util::convertLineBreaksToHTML($u->getBio()) . '</p>' : ""; ?>
