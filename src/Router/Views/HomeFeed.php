								...
								<div class="px-2 py-1 my-1" style="height: 70px">
									...
									<div class="ml-2 float-left">
										<a href="/<?= $u->getUsername(); ?>" class="clearUnderline" data-user-id="<?= $u->getId() ?>">
											<div class="font-weight-bold float-left small mt-1 convertEmoji" style="max-width: 100px; overflow: hidden !important; text-overflow: ellipsis !important; white-space: nowrap !important; word-wrap: normal !important;"><?= $u->getDisplayName() . $u->renderCheckMark() ?></div>
